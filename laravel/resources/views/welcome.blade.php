                        ...
                        <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;"
                            ...
                            <ul>
                                ...
                                <li data-index="rs-1000" data-transition="slidingoverlayhorizontal"
                                    ...
                                    data-thumb="{{ URL::to('/') }}/upload/banners/{{ $ban->photo }}" data-rotate="0"
                                    data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
                                    data-param3="" data-param4="" data-param5="" data-param6="" data-param7=""
                                    data-param8="" data-param9="" data-param10="" data-description="">
                                    <!-- MAIN IMAGE -->
                                    <img src="{{ URL::to('/') }}/upload/banners/{{ $ban->photo }}" alt=""
    ...
    <div class="section-full bg-white p-t80 p-b50">
        <div class="container">
            ...
            <div class="section-head">
                <h2 class="text-uppercase"> Upcoming Project</h2>
                <div class="wt-separator-outer">
                    <div class="wt-separator style-square">
                        <span class="separator-left bg-primary"></span>
                        <span class="separator-right bg-primary"></span>
                    ...
                    <div class="item">
                        <div class="ow-event-post date-style-2">
                            <div class="ow-event-media wt-img-effect img-reflection">
                                <img src="{{ URL::to('/') }}/upload/projectsave/{{ $pro->photo }}"
                                    alt="{{ $pro->project_name }}">
                            </div>
                            <div class="ow-event-info p-a30 bg-gray">
                                <div class="ow-event-title">
                                    <h4 class="event-title">{{ $pro->project_name }}<a
                                            href="{{ url('project') }}/{{ $pro->id }}"
                                ...
                                <div class="ow-event-readmore ">
                                    <a href="{{ url('project') }}/{{ $pro->id }}" title="{{ $pro->project_name }}"
                    ...
                    <div class="item">
                        <div class="ow-event-post date-style-2">
                            ...
                            <div class="ow-event-info p-a30 bg-gray">
                                ...
                                <div class="ow-event-readmore ">
                                    <a href="{{ url('project') }}/{{ $pro->photo }}" title="{{ $pro->project_name }}"
                                        rel="bookmark" class=" site-button"> READ MORE</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        <div class="ow-event-post date-style-2">
                            ...
                            <div class="ow-event-info p-a30 bg-gray">
                                ...
                                <div class="ow-event-readmore ">
                                    <a href="{{ url('project') }}/{{ $pro->id }}" title="{{ $pro->photo }}"
                                        rel="bookmark" class=" site-button"> READ MORE</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-9">
                        <div class="filter-wrap p-tb15 right">
                            <ul class="masonry-filter outline-style button-skew text-uppercase customize">
                                ...
                                <li><a data-filter=".{{ $pro->id }}"><span> {{ $pro->project_status_name }}</span></a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
                                ...
                                <div class="wt-thum-bx wt-img-effect img-reflection p-a15">
                                    ...
                                    <div class="overlay-bx">
                                        <div class="overlay-icon">
                                            ...
                                            <a href="{{ URL::to('/') }}/upload/projectsave/{{ $pro->photo }}"
                                                alt="{{ $pro->project_name }}" class="mfp-link">
