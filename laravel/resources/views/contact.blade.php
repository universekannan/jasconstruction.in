...
<head>
    ...
    <meta name="copyright" content="Contact Us Jas Construction" />
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12 m-b30">
                                    <div class="wt-icon-box-wraper center p-a30 bdr-2 bdr-gray-light">
                                        ...
                                        <div class="icon-content">
                                            <h5>Phone</h5>
                                            <p>
                                                <a href="tel:+919894180324">+91 98941 80324</a><br>
                                                <a href="tel:+918940906655">+91 89 4090 6655</a>
                                            </p>
                                            <p></p>
                                        </div>
                                    </div>
                ...
                <div class="section-content ">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-right">
                                            <button name="submit" type="submit" value="Submit"
                                                class="site-button skew-icon-btn m-r15">Submit <i
                                                    class="fa fa-angle-double-right"></i></button>
                                            <button name="Resat" type="reset" value="Reset"
                                                class="site-button skew-icon-btn">Reset <i
                                                    class="fa fa-angle-double-right"></i></button>
                                        </div>
                        ...
                        <div class="wt-box col-md-6">
                            ...
                            <div class="wt-icon-box-wraper center p-a30 bdr-2 bdr-gray-light">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15796.436554878395!2d77.39915400000001!3d8.19175995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b04f0c9c8f8dafd%3A0x20f6553173a34848!2sParvathipuram%2C%20Nagercoil%2C%20Tamil%20Nadu%20629003!5e0!3m2!1sen!2sin!4v1729682526628!5m2!1sen!2sin"
                                    width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"
                                    referrerpolicy="no-referrer-when-downgrade" width="600" height="450"
                                    style="border:0;" allowfullscreen="" loading="lazy"
                                    referrerpolicy="no-referrer-when-downgrade" width="100%" height="350"
    ...
    <footer class="site-footer footer-dark">
        ...
        <div class="call-to-action-wrap call-to-action-skew"
            style="background-image:url(assets/images/background/bg-4.png); background-repeat:repeat;background-color:#273447;">
