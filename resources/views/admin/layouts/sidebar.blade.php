<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="{{ url('admin/dashboard') }}" class="brand-link">
        <img src="{{ asset('/assets/images/preloader.gif') }}" class="brand-image img-circle elevation-3">JAS Construction
    </a>
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item has-treeview {{ Request::is('admin/setting*') || Request::is('admin/web_setting*') || Request::is('admin/govt_bank*') || Request::is('users/permissions*') || Request::is('admin/backup*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin/web_setting') }}"
                                class="nav-link {{ Request::is('admin/web_setting') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Website Setting</p>
                            </a>
                        </li>
