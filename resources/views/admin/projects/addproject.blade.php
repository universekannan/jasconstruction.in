                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('saveproject') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select required="required" type="text" class="form-control" name="project_status_id"
                                    maxlength="50">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input required="required" type="text" class="form-control" name="project_name"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input required="required" type="text" class="form-control" name="project_owner"
                                    maxlength="50" placeholder="Project owner">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input required="required" type="text" class="form-control" name="project_sqft"
                                    maxlength="50" placeholder="SQFT">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <button type="button" id="cropBtn" class="btn btn-success" style="display:none;">
                                    Crop Image
                                </button>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea required="required" type="text" class="form-control" name="project_address"
...
<script>
function edit_project(id, project_name, project_owner, project_mobile, project_email, project_amount, photo,
    project_address) {
    $("#editid").val(id);
...
if (value.attr_type == "text") {
    $("#attrdiv").append("<div class='form-group row'><label class='col-sm-2 col-form-label'>" + value.attr_name +
        "</label> <div class='col-sm-10'><input name='" + name +
        "' type='text' maxlength='100' class='form-control'/></div></div>");
} else if (value.attr_type == "date") {
    $("#attrdiv").append("<div class='form-group row'><label class='col-sm-2 col-form-label'>" + value.attr_name +
        "</label><div class='col-sm-10'><input name='" + name +
        "' onkeyup='return false' type='date' class='form-control'  /></div></div>");
} else if (value.attr_type == "textarea") {
    $("#attrdiv").append("<div class='form-group row'><label class='col-sm-2 col-form-label'>" + value.attr_name +
        "</label><div class='col-sm-10'><textarea name='" + name +
        "' maxlength='500' class='form-control' ></textarea></div></div>");
    ...
    $("#attrdiv").append("<div class='form-group row'><label class='col-sm-2 col-form-label'>" + value.attr_name +
        "</label><div class='col-sm-10'><select name='" + name + "' class='form-control'>" + option +
        "</select></div></div>");
    ...
    while (j < myArray.length) {
        option = option + "<label ><input name='" + name + "[]' type='checkbox' class='checkbox-inline ' value='" +
            myArray[j] + "' />&nbsp;" + myArray[j].toString() + "&nbsp;</label>";
        j++;
    }
    console.log(option);
...
function addInput() {
    ...
    newdiv.innerHTML = "Entry " + (counter + 1) +
        " <br><input type='text' name='myInputs[]'> <input type='button' value='-' onClick='removeInput(" +
