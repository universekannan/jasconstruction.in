...
<head>
    ...
    <title>LIVE BUILDERS <?php echo $_SESSION['full_name']; ?></title>
...
<body>
	...
	?>
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                 <a href="pending.php" ><span class="pull-left">View Details</span></a>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
	...
	?>
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <a href="transfer.php" ><span class="pull-left">View Details</span></a>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
