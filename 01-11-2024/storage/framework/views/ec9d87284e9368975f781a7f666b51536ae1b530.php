                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="example2" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $bannersslist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($key + 1); ?></td>
                                            <td><?php echo e($bannersslist->id); ?></td>
                                            <td><?php echo e($bannersslist->banner_name); ?></td>
                                            <td><img src="../upload/banners/<?php echo e($bannersslist->photo); ?>" width="50" height="50"></td>

                                            <?php if($bannersslist->status == 1): ?>
                                                <td>Active</td>
                                            <?php else: ?>
                                                <td>Inactive</td>
                                            <?php endif; ?>
                                            <td style="white-space: nowrap">
                                                <a onclick="edit_banners('<?php echo e($bannersslist->id); ?>','<?php echo e($bannersslist->banner_name); ?>','<?php echo e($bannersslist->banner_url); ?>','<?php echo e($bannersslist->description); ?>','<?php echo e($bannersslist->photo); ?>','<?php echo e($bannersslist->status); ?>')"
                                                    href="#" class="btn btn-sm btn-primary"><i
                                                        class="fa fa-edit"></i>Edit</a>

                                                <a onclick="return confirm('Do you want to Confirm delete operation?')"
                                                    href="<?php echo e(url('/deletebanners', $bannersslist->id)); ?>"
                        ...
                        <div class="modal fade" id="addbanner">
                            <form action="<?php echo e(url('/addbanner')); ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="modal fade" id="editbanners">
                            <form action="<?php echo e(url('/updatebanners')); ?>" enctype="multipart/form-data" method="post">
                                <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('admin/layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jasconstruction.in\01-11-2024\resources\views/admin/banners/index.blade.php ENDPATH**/ ?>