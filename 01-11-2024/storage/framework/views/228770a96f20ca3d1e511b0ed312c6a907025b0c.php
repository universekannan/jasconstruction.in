...
<head>
    ...
    <div class="page-content">
                        ...
                        <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;"
                            ...
                            <ul>
                                ...
                                <li data-index="rs-1000" data-transition="slidingoverlayhorizontal"
                                    ...
                                    data-thumb="<?php echo e(URL::to('/')); ?>/upload/banners/<?php echo e($ban->photo); ?>" data-rotate="0"
                           ...
                           {"delay":"wait","speed":1000,"to":"opacity:0;","ease":"Power4.easeOut"}
                                    ...
                                    <div class="tp-caption   tp-resizeme" id="slide-100-layer-2"
                                        ...
                                        data-fontsize="['60','60','60','50']" data-lineheight="['70','70','70','60']"
                           ...
                           border-width:0px;">
                                        <span class="text-uppercase" style="font-family:'Roboto' ;"><span
                                                class="text-primary fts"><?php echo e($ban->banner_name); ?>
                                    ...
                                    <div class="tp-caption  tp-resizeme" id="slide-100-layer-3"
                                        ...
                                        data-fontsize="['18','18','18','30']" data-lineheight="['30','30','30','40']"
        ...
        <div class="section-full p-tb100"
            style="background-image:url(images/background/pic-c-1bg.png); background-position:left bottom; background-repeat:no-repeat;">
            <div class="container">
                <div class="row">
                    ...
                    <div class="item">
                        <div class="ow-event-post date-style-2">
                            <div class="ow-event-media wt-img-effect img-reflection">
                                <img src="<?php echo e(URL::to('/')); ?>/upload/projectsave/<?php echo e($pro->photo); ?>"
                                    alt="<?php echo e($pro->project_name); ?>">
                            </div>
                            <div class="ow-event-info p-a30 bg-gray">
                                <div class="ow-event-title">
                                    <h4 class="event-title"><?php echo e($pro->project_name); ?><a
                                            href="<?php echo e(url('project')); ?>/<?php echo e($pro->id); ?>"
                                            title="<?php echo e($pro->project_name); ?>"></a></h4>
                                </div>
                                <div class="ow-event-text">
                                    <p><?php echo e($pro->project_name); ?>,
                                        <?php echo e($pro->project_name); ?><?php echo e($pro->project_owner); ?>,'<?php echo e($pro->project_address); ?>

                                    </p>
                                </div>
                                <div class="ow-event-readmore ">
                                    <a href="<?php echo e(url('project')); ?>/<?php echo e($pro->id); ?>" title="<?php echo e($pro->project_name); ?>"
                                        rel="bookmark" class=" site-button"> READ MORE</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="ow-event-post date-style-2">
                            ...
                            <div class="ow-event-info p-a30 bg-gray">
                                ...
                                <div class="ow-event-readmore ">
                                    <a href="<?php echo e(url('project')); ?>/<?php echo e($pro->photo); ?>" title="<?php echo e($pro->project_name); ?>"
                                        rel="bookmark" class=" site-button"> READ MORE</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        <div class="ow-event-post date-style-2">
                            ...
                            <div class="ow-event-info p-a30 bg-gray">
                                ...
                                <div class="ow-event-readmore ">
                                    <a href="<?php echo e(url('project')); ?>/<?php echo e($pro->id); ?>" title="<?php echo e($pro->photo); ?>"
                                        rel="bookmark" class=" site-button"> READ MORE</a>
                                </div>
                            </div>
                        </div>
    ...
    <div class="section-full bg-gray p-t80 p-b120"
        style="background-image:url(images/background/why-choose-pic.png); background-repeat:no-repeat; background-position:right bottom;">
        -
        <div class="container">
            <!-- TITLE START-->
            <div class="section-head text-center">
                ...
                <p>We specialize in building premier and Baget residential projects . We bring you the finest homes that
                    are unsurpassed in quality and elegance.</p>
            </div>
            <!-- TITLE END-->
                        ...
                        <div class="section-content m-b50 ">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6 m-tb20 bg-white">
                                    <div class="wt-icon-box-wraper center">
                                        <div class="wt-icon-box-sm radius text-primary bdr-2 m-b20">
                                            <a href="contact-us.php" class="icon-cell"><i
    ...
    <div class="section-full p-t80"
        style="background-image:url('<?php echo e(asset('assets/images/background/bg-4.png')); ?>'); background-repeat:repeat;background-color:#273447; ">
                    ...
                    <div class="col-md-9">
                        <div class="filter-wrap p-tb15 right">
                            <ul class="masonry-filter outline-style button-skew text-uppercase customize">
                                ...
                                <li><a data-filter=".<?php echo e($pro->id); ?>"><span> <?php echo e($pro->project_status_name); ?></span></a>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
        ...
        <div class="section-full p-t80 p-b50  bg-no-repeat bg-bottom-center bg-cover"
            style="background-image:url('<?php echo e(asset('assets/images/background/bg-6.jpg')); ?>');">
            <div class="container">
                            ...
                            <div class="wt-gallery-bx p-a15">
                                <div class="wt-thum-bx wt-img-effect img-reflection p-a15">
                                    <a href="javascript:void(0);">
                                        <img src="<?php echo e(URL::to('/')); ?>/upload/projectsave/<?php echo e($pro->photo); ?>"
                                            alt="<?php echo e($pro->project_name); ?>" alt="">
                                    </a>
                                    <div class="overlay-bx">
                                        <div class="overlay-icon">
                                            ...
                                            <a href="<?php echo e(URL::to('/')); ?>/upload/projectsave/<?php echo e($pro->photo); ?>"
                                                alt="<?php echo e($pro->project_name); ?>" class="mfp-link">
   ...
   <div class="container">
    ...
    <div class="section-full p-t80 p-b50 overlay-wraper " data-stellar-background-ratio="0.5"
        style="background-image:url('<?php echo e(asset('assets/images/background/bg3.jpg')); ?>');">
                    ...
                    <div class="item">
                        <div class="testimonial-1 testimonial-bg">
                            <div class="testimonial-pic quote-left radius shadow"><img src="images/main.jpg" width="100"
                                    height="100" alt=""></div>
                            <div class="testimonial-text">
                                <p>A very professional organisation which operate to good ethical standards. My
                                    experiences have been nothing short of super! Keep up the good work.</p>
                            </div>
                            <div class="testimonial-detail">
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-8">
                        <div class="call-to-action-left p-tb20 p-r50">
                            <h4 class="text-uppercase m-b10">We are ready to build your dream tell us more about your
                                project</h4>
                            <p></p>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jasconstruction.in\01-11-2024\resources\views/welcome.blade.php ENDPATH**/ ?>