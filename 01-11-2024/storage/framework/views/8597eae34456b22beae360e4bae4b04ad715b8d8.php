...
<meta name="copyright" content="About Us Jas Construction" />
<link rel="shortcut icon" href="images/logo.png" title="About Us Jas Construction"  />
<link href="" rel="search" title="Search About Us Jas Construction" type="application/opensearchdescription+xml"/>
            ...
            <div class="col-md-9">
               <div class="blog-post blog-lg date-style-3 date-skew">
                  <div class="wt-post-media wt-img-effect zoom-slow">
                     <a href="javascript:void(0);"><img src="assets/images/blog/default/house-5.jpg" alt=""></a>
                  </div>
                  <div class="wt-post-info p-a30 p-b15  bg-white">
                     <div class="wt-post-title ">
                        <h3 class="post-title"><a href="javascript:void(0);">About  Jas Construction</a></h3>
                     </div>
                     <div class="wt-post-text">
                        <p>JAS  Construction is one of the best Construction in Kanniyakumari,Tamilnadu. We specialize in building premier and Baget residential projects . We bring you the finest homes that are unsurpassed in quality and elegance.</p>
                     </div>
                     <div class="wt-post-title ">
                     ...
                     <div class="wt-post-title ">
                        <h3 class="post-title"><a href="javascript:void(0);">Our Vision </a></h3>
                     </div>
                     <div class="wt-post-text">
                     ...
                     <div class="item">
                        <div class="ow-client-logo">
                           <div class="client-logo wt-img-effect client-logo-media on-color bdr-1 bdr-gray">
                              <a href="javascript:void(0);"><img src="<?php echo e(URL::to('/')); ?>/upload/projectsave/<?php echo e($pro->photo); ?>" alt=""></a>
                           </div>
                        </div>
                     </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jasconstruction.in\01-11-2024\resources\views/about.blade.php ENDPATH**/ ?>