        ...
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(url('saveproject')); ?>" method="post" enctype="multipart/form-data">
                           ...
                           <label for="project_mobile" class="col-sm-2 col-form-label"><span
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="col-md-12 text-center">
                                    <a class="btn btn-primary" href="<?php echo e(url('admin/project')); ?>">Back</a>
...
<?php echo $__env->make('admin/layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jasconstruction.in\01-11-2024\resources\views/admin/projects/addproject.blade.php ENDPATH**/ ?>