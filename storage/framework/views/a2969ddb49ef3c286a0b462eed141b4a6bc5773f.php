...
<link rel="shortcut icon" href="<?php echo asset('images/logo.png'); ?>" title="LIVE Builders"  />
...
<meta name="viewport" content="width=device-width, initial-scale=1"/>
  <!-- FAVICONS ICON -->
  <link rel="icon" href="<?php echo asset('images/logo.png'); ?>" type="image/x-icon" />
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo asset('assets/css/bootstrap.min.css'); ?>"><!-- BOOTSTRAP STYLE SHEET -->
  <link rel="stylesheet" type="text/css" href="<?php echo asset('assets/css/fontawesome/css/font-awesome.min.css'); ?>"><!-- FONTAWESOME STYLE SHEET -->
  <link rel="stylesheet" type="text/css" href="<?php echo asset('assets/css/flaticon.min.css'); ?>"><!-- FLATICON STYLE SHEET -->
  <link rel="stylesheet" type="text/css" href="<?php echo asset('assets/css/animate.min.css'); ?>"><!-- ANIMATE STYLE SHEET --> 
  <link rel="stylesheet" type="text/css" href="<?php echo asset('assets/css/owl.carousel.min.css'); ?>"><!-- OWL CAROUSEL STYLE SHEET -->
  <link rel="stylesheet" type="text/css" href="<?php echo asset('assets/css/bootstrap-select.min.css'); ?>"><!-- BOOTSTRAP SELECT BOX STYLE SHEET -->
  <link rel="stylesheet" type="text/css" href="<?php echo asset('assets/css/magnific-popup.min.css'); ?>"><!-- MAGNIFIC POPUP STYLE SHEET -->
  <link rel="stylesheet" type="text/css" href="<?php echo asset('assets/css/loader.min.css'); ?>"><!-- LOADER STYLE SHEET --> 
  <link rel="stylesheet" type="text/css" href="<?php echo asset('assets/css/style.css'); ?>"><!-- MAIN STYLE SHEET -->
  <link rel="stylesheet" type="text/css" class="skin" href="<?php echo asset('assets/css/skin/skin-1.css'); ?>"><!-- THEME COLOR CHANGE STYLE SHEET -->
  <link rel="stylesheet" type="text/css" href="<?php echo asset('assets/css/switcher.css'); ?>"><!-- SIDE SWITCHER STYLE SHEET -->  
...
<body id="bg">
    ...
    <?php echo $__env->yieldContent('third_party_scripts'); ?>
      ...
      <!-- LOADING AREA  END ====== -->
      <!-- JAVASCRIPT  FILES ========================================= --> 
      <script type="text/javascript"  src="assets/js/jquery-1.12.4.min.js"></script><!-- JQUERY.MIN JS -->
      <script type="text/javascript"  src="assets/js/bootstrap.min.js"></script><!-- BOOTSTRAP.MIN JS -->
      <script type="text/javascript"  src="assets/js/bootstrap-select.min.js"></script><!-- FORM JS -->
      <script type="text/javascript"  src="assets/js/jquery.bootstrap-touchspin.min.js"></script><!-- FORM JS -->
      <script type="text/javascript"  src="assets/js/magnific-popup.min.js"></script><!-- MAGNIFIC-POPUP JS -->
      <script type="text/javascript"  src="assets/js/waypoints.min.js"></script><!-- WAYPOINTS JS -->
      <script type="text/javascript"  src="assets/js/counterup.min.js"></script><!-- COUNTERUP JS -->
      <script type="text/javascript"  src="assets/js/waypoints-sticky.min.js"></script><!-- COUNTERUP JS -->
      <script type="text/javascript" src="assets/js/isotope.pkgd.min.js"></script><!-- MASONRY  -->
      <script type="text/javascript"  src="assets/js/owl.carousel.min.js"></script><!-- OWL  SLIDER  -->
      <script type="text/javascript"  src="assets/js/stellar.min.js"></script><!-- PARALLAX BG IMAGE   --> 
      <script type="text/javascript"  src="assets/js/scrolla.min.js"></script><!-- ON SCROLL CONTENT ANIMTE   -->
      <script type="text/javascript"  src="assets/js/custom.js"></script><!-- CUSTOM FUCTIONS  -->
      <script type="text/javascript"  src="assets/js/shortcode.js"></script><!-- SHORTCODE FUCTIONS  -->
      <script type="text/javascript"  src="assets/js/switcher.js"></script><!-- SWITCHER FUCTIONS  -->
      <!-- REVOLUTION JS FILES -->
...
<?php /**PATH C:\xampp\htdocs\livebuilders.in\resources\views/layout/app.blade.php ENDPATH**/ ?>