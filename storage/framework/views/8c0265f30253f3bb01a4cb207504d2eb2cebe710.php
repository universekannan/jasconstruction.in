				...
				<div class="container">
					<div class="spe-title tit-inn-pg">
						...
						<ul>
							...
							<li><a href="#" class="bread-acti">Travels</a>
							</li>
						</ul>
					</div>
				</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\prahanaatours.com\resources\views/travels.blade.php ENDPATH**/ ?>