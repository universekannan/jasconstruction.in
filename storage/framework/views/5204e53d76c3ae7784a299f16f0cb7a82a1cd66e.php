        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(url('addsubcategory')); ?>" enctype="multipart/form-data"  method="post">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="hidden" class="form-control" name="category_id"
                                            value="<?php echo e($cat_id); ?>">
                                        <input type="text" class="form-control" value="<?php echo e($cat_name); ?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row text-center">
                                    <div class="col-md-12 ">
                                        ...
                                        <a href="<?php echo e(url('admin/category')); ?>" class="btn btn-info">Back</a>
                                    </div>
                                </div>
                            </div>
                    </form>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($cat->category_name); ?></td>
                             <td><img src="../../upload/catimage/<?php echo e($cat->photo); ?>" width="50" height="50"></td>
                            <?php if($cat->status == 1): ?>
                            <td>Active</td>
                            <?php else: ?>
                            <td>Inactive</td>
                            ...
                            <td>
                                <a onclick="edit_subcategory('<?php echo e($cat->id); ?>','<?php echo e($cat->category_name); ?>','<?php echo e($cat->status); ?>')"
                                    href="#" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>Edit</a>

                                <a onclick="return confirm('Do you want to Confirm delete operation?')" href="<?php echo e(url('deletesubcategory', $cat->id)); ?>" class="btn btn-danger btn-sm"><i
                ...
                <div class="modal fade" id="editsubcategory" tabindex="-1" aria-hidden="true">
                    <form action="<?php echo e(url('editsubcategory')); ?>" enctype="multipart/form-data"  method="post">
                        <?php echo e(csrf_field()); ?>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="Hidden" name="parent_id" value="<?php echo e($cat_id); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin/layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vijayhardwares.in\resources\views/admin/category/subcategory.blade.php ENDPATH**/ ?>