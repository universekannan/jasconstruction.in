...
<meta name="copyright" content="Jas Construction" />
<link rel="shortcut icon" href="images/logo.png" title="Jas Construction"  />
<link href="" rel="search" title="Search Jas Construction" type="application/opensearchdescription+xml"/>
...
<?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ban): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <li data-index="rs-1000" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="<?php echo e(URL::to('/')); ?>/upload/banners/<?php echo e($ban->photo); ?>"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="<?php echo e(URL::to('/')); ?>/upload/banners/<?php echo e($ban->photo); ?>"  alt=""  data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina/>
                        ...
                        <div class="tp-caption   tp-resizeme" 
                           ...
                           border-width:0px;">
                           <span class="text-uppercase" style="font-family:'Roboto' ;"><span class="text-primary"><?php echo e($ban->banner_name); ?>
                        ...
                        <div class="tp-caption  tp-resizeme" 
                           ...
                           border-width:0px;">
                           <span style="font-family:'Roboto';"><?php echo e($ban->description); ?></span>
                        </div>
                        ...
                        <div class="tp-caption tp-resizeme" 	
                           ...
                           <a href="<?php echo e(url('/projects')); ?>/3" class="site-button button-lg skew-icon-btn m-r15">Read more <i class="fa fa-angle-double-right"></i></a>
                        </div>
                     </li>
         ...
         <div class="row">
            ...
            <div class="col-md-7 col-sm-7">
               <div class="section-head text-left">
                  <h2 class="text-uppercase">Welcome to Jas Builders</h2>
                  ...
                  <div class="list-style">
                     ...
                     <a href="images/e-brochure.pdf" download class="site-button skew-icon-btn m-r15 text-uppercase"  style="font-weight:600;">Download e-brochure<i class="fa fa-angle-double-right"></i></a>
                  </div>
               </div>
            ...
            <div class="item">
               <div class="ow-event-post date-style-2">
                  <div class="ow-event-media wt-img-effect img-reflection">
                     <img src="<?php echo e(URL::to('/')); ?>/upload/projectsave/<?php echo e($pro->photo); ?>" alt="<?php echo e($pro->project_name); ?>">
                  </div>
                  <div class="ow-event-info p-a30 bg-gray">
                     <div class="ow-event-title">
                        <h4 class="event-title"><?php echo e($pro->project_name); ?><a href="<?php echo e(url('project')); ?>/<?php echo e($pro->id); ?>" title="<?php echo e($pro->project_name); ?>"></a></h4>
                     </div>
                     ...
                     <div class="ow-event-readmore "> 
                        <a href="<?php echo e(url('project')); ?>/<?php echo e($pro->id); ?>" title="<?php echo e($pro->project_name); ?>" rel="bookmark" class=" site-button"> READ MORE</a> 
                     </div>
                  </div>
               </div>
            </div>
...
<div class="section-full bg-white p-t80 p-b50">
   <div class="container">
      <!-- Event post Carousel with no margin -->
      <div class="section-head">
         <h2 class="text-uppercase">Progress Project </h2>
         <div class="wt-separator-outer">
            <div class="wt-separator style-square">
               <span class="separator-left bg-primary"></span>
               <span class="separator-right bg-primary"></span>
            ...
            <div class="item">
               <div class="ow-event-post date-style-2">
                  ...
                  <div class="ow-event-info p-a30 bg-gray">
                     ...
                     <div class="ow-event-readmore "> 
                        <a href="<?php echo e(url('project')); ?>/<?php echo e($pro->photo); ?>" title="<?php echo e($pro->project_name); ?>" rel="bookmark" class=" site-button"> READ MORE</a> 
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="item">
               <div class="ow-event-post date-style-2">
                  ...
                  <div class="ow-event-info p-a30 bg-gray">
                     ...
                     <div class="ow-event-readmore "> 
                        <a href="<?php echo e(url('project')); ?>/<?php echo e($pro->id); ?>" title="<?php echo e($pro->photo); ?>" rel="bookmark" class=" site-button"> READ MORE</a> 
                     </div>
                  </div>
               </div>
            </div>
...
<div class="container">
   ...
   <div class="section-head text-center">
      ...
      <p>We specialize in building premier and Baget residential projects . We bring you the finest homes that are unsurpassed in quality and elegance.</p>
   </div>
   <!-- TITLE END-->
               ...
               <div class="row">
                  ...
                  <div class="col-md-4 col-sm-6 m-tb20 bg-white">
                     <div class="wt-icon-box-wraper center">
                        <div class="wt-icon-box-sm radius text-primary bdr-2 m-b20">
                           <a href="contact-us.php" class="icon-cell"><i class="fa fa-trophy"></i></a>
                        </div>
                        <div class="icon-content">
                  ...
                  <div class="col-md-4 col-sm-6 m-tb20 bg-white">
                     <div class="wt-icon-box-wraper center">
                        <div class="wt-icon-box-sm radius text-primary bdr-2 m-b20">
                           <a href="contact-us.php" class="icon-cell"><i class="fa fa-pencil"></i></a>
                        </div>
                        <div class="icon-content">
                  ...
                  <div class="col-md-4 col-sm-6 m-tb20 bg-white">
                     <div class="wt-icon-box-wraper center">
                        <div class="wt-icon-box-sm radius text-primary bdr-2 m-b20">
                           <a href="contact-us.php" class="icon-cell"><i class="fa fa-flag-checkered"></i></a>
                        </div>
                        <div class="icon-content">
                  ...
                  <div class="col-md-4 col-sm-6 m-tb20 bg-white">
                     <div class="wt-icon-box-wraper center">
                        <div class="wt-icon-box-sm radius text-primary bdr-2 m-b20">
                           <a href="contact-us.php" class="icon-cell"><i class="fa fa-hand-rock-o"></i></a>
                        </div>
                        <div class="icon-content">
                  ...
                  <div class="col-md-4 col-sm-6 m-tb20 bg-white">
                     <div class="wt-icon-box-wraper center">
                        <div class="wt-icon-box-sm radius text-primary bdr-2 m-b20">
                           <a href="contact-us.php" class="icon-cell"><i class="fa fa-recycle"></i></a>
                        </div>
                        <div class="icon-content">
                  ...
                  <div class="col-md-4 col-sm-6 m-tb20 bg-white">
                     <div class="wt-icon-box-wraper center">
                        <div class="wt-icon-box-sm radius text-primary bdr-2 m-b20">
                           <a href="contact-us.php" class="icon-cell"><i class="fa fa-graduation-cap"></i></a>
                        </div>
                        <div class="icon-content">
...
<div class="section-full p-t80 p-b50 overlay-wraper " data-stellar-background-ratio="0.5" style="background-image:url(images/background/bg3.jpg);">
         ...
         <div class="owl-carousel testimonial-one">
            <div class="item">
               <div class="testimonial-1 testimonial-bg">
                  <div class="testimonial-pic quote-left radius shadow"><img src="images/main.jpg" width="100" height="100" alt=""></div>
                  <div class="testimonial-text">
                     <p>Very good builders who provides nice housing.My first investment is with Jas builders and I have gained very good returns</p>
                  </div>
...
<div class="loading-area" style="">
   ...
   <div class="loading-pic">
      ...
      <div id="cssload-cupcake" class="cssload-box">
         <span class="cssload-letter">JAS</span>
         ...
         <span class="cssload-letter cssload-box">C</span>
         <span class="cssload-letter cssload-box">O</span>
         <span class="cssload-letter cssload-box">N</span>
         <span class="cssload-letter cssload-box">S</span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jasconstruction.in\resources\views/welcome.blade.php ENDPATH**/ ?>