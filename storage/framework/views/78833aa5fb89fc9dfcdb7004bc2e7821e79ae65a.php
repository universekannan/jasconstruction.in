                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="centered-title">
                            <h2>Products<span class="heading-border"></span></h2>
                            <div class="clear"></div>
                            <em><?php echo e($category_name); ?></em>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3 col-lg-offset-0 col-md-3 col-md-offset-0 col-sm-4 col-sm-offset-0 col-xs-12 col-xs-offset-0 mix" >
                        <div class="wa-products">
                            <div class="wa-products-thumbnail wa-item">
                                <img src="<?php echo e(URL::to('/')); ?>/upload/productS/<?php echo e($pro->photo); ?>" alt="">
...
<?php echo $__env->make('web/layouts.other_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vijayhardwares.in\resources\views/web/products/categoryproduct.blade.php ENDPATH**/ ?>