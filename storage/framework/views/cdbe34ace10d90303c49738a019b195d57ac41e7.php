...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('/AdminLTELogo.png')); ?>">
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed sidebar-collapse">
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown user-menu">
                    ...
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                        <img src="<?php echo e(URL::to('/')); ?>/upload/user.jpg"
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-footer">
                            <a href="<?php echo e(url('/logout')); ?>" class="btn btn-default btn-flat float-right"
                               >Log Out</a>
                        </li>
                    </ul>
                </li>
        ...
        <footer class="main-footer">
            <strong><a target="_blank" href="https://vijayhardwares.in/">Vijay Hardwares</a></strong> 2023 &copy; All Rights Reserved.
        </footer>
    </div>
    ...
    <script src="<?php echo asset('plugins/bootstrap-switch/js/bootstrap-switch.min.js'); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\vijayhardwares.in\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>