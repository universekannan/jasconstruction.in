...
<link href="<?php echo asset('assets/css/responsive.css'); ?>" rel="stylesheet" id="colors">
  ...
  <body>
<?php echo $__env->make('web/layouts.other_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->yieldContent('web/third_party_scripts'); ?>
        ...
        <script src="<?php echo asset('assets/plugins/fancymedia/js/jquery.fancybox.pack.js'); ?>"></script>
        <script src="<?php echo asset('assets/plugins/fancymedia/js/jquery.fancybox-media.js'); ?>"></script>   
    <?php echo $__env->yieldPushContent('web/page_scripts'); ?>
	
</body>

</html>
<?php /**PATH C:\xampp\htdocs\vijayhardwares.in\resources\views/web/layouts/other_app.blade.php ENDPATH**/ ?>